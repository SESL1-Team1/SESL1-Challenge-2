...
const Login: React.FC = () => {
    ...
    return (
        <div className="login w-3/12 my-[calc(8%)] mx-auto rounded-lg text-md border-4 border-purple-600 border-double font-mono bg-purple-100 p-8">
            ...
            <form onSubmit={login} className="space-y-6">
                ...
                <p className="text-center">Not registered? <a href="/register" className="font-semibold">Register here</a></p>
